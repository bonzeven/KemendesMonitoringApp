...
import com.bchannel.kemmon.domain.PersistentToken;
...
import com.bchannel.kemmon.web.rest.vm.KeyAndPasswordVM;
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getEmail().toLowerCase(), managedUserVM.getLangKey(),managedUserVM.getUser_type());
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.getUser_type());
